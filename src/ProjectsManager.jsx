      ...
      {editingItem !== null && (
        <form onSubmit={handleSubmit} className="bg-slate-800 rounded-2xl shadow-xl p-6 mb-8 border border-slate-700">
          ...
          <div className="space-y-3">
            ...
            <input type="text" placeholder="Tech Stack (comma separated)" value={formData.tech_stack || ''} onChange={(e) => setFormData({ ...formData, tech_stack: (e.target.value ? e.target.value.split(',') : []) })} className="w-full p-3 bg-slate-900 border border-slate-700 rounded-lg text-white" />
